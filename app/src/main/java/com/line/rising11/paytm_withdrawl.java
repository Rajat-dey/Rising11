...
public class paytm_withdrawl extends AppCompatActivity {
...
*/
                                    ...
                                    editor.commit();*/
                                    Toast.makeText(paytm_withdrawl.this, response.getString("msg"), Toast.LENGTH_SHORT).show();
            ...
            RestClient.getInstance(paytm_withdrawl.this).addToRequestQueue(jsonObjectRequest);
