...
public class ContestFilterRecyclerDataClass {
    private String prize,entry,max_pb_val,min_pb_val,winner,box1,box2;
    public ContestFilterRecyclerDataClass(String prize,String entry,String max_pb_val,String min_pb_val,String winner,String box1,String box2)
    {
        this.prize=prize;
        this.entry=entry;
